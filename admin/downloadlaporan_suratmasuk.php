...
// Set properties
$excelku->getProperties()->setCreator("ALDI")
...
$excelku->getActiveSheet()->setCellValue('A2', "PEMERINTAH KOTA PADANG");
$excelku->getActiveSheet()->mergeCells('A3:H3');
$excelku->getActiveSheet()->setCellValue('A3', "KANTOR BALAI KOTA PADANG");
...
$excelku->getActiveSheet()->setCellValue('A5', "Jl. Jend. Sudirman, Kota padang, Sumatera Barat ");
