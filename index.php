...
<html lang="en">
  <head>
    ...
    <title>Arsip Surat Kota Padang</title>
        ...
        <nav class="navbar navbar-default navbar-fixed-top">
          <div class="container">
            <div class="navbar-header">
              ...
              <a class="navbar-brand" href="#">ARSIP SURAT <span class="logo-dec">PemKot Padang</span></a>
            </div>
        ...
        <div class="container">
          <div class="row">
            <div class="banner-info text-center wow fadeIn delay-05s">
              ...
              <div class="logo">
		            <img src="img/padang.png" alt="" />
	            </div>
              <h3 class="bnr-sub-title">SISTEM INFORMASI PENGARSIPAN SURAT</h3>
                <h3 class="bnr-sub-title"><span class="logo-dec">PEMERINTAH KOTA PADANG</span></h3>
            </div>
          </div>
        </div>
        </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <p class="sub-title pad-bt15">Website ini berguna untuk pengarsipan Surat Masuk dan Surat Keluar di Pemerintah Kota Padang</p><p>Surat diarsipkan dalam format PDF lalu disesuaikan nomor urutnya.</p>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6 col-sm-6 col-xs-12 portfolio-item padding-right-zero mr-btn-15">
            <figure>
              <img src="img/arsip.jpg" class="img-responsive">
              <figcaption>
                  <h2>Rifaldi</h2>
                  <p>"Fresh Graduate"</p>
    ...
    <footer id="footer">
      <div class="container">
        <div class="row text-center">
          <p>&copy; Rifaldi. All Rights Reserved.</p>
          <div class="credits">
            <!-- 
            ...
            -->
            Designed  by <a href="https://bootstrapmade.com/">Bootstrap Rifaldi</a>
        </div>
        </div>
      </div>
    </footer>
